...
import { getGitHubLoginUrl } from "../services/gitkutApi";
...
<template>
  <div class="flex min-h-screen flex-col bg-gitkut-bg text-gitkut-ink">
    ...
    <main class="mx-auto flex w-full max-w-gitkut flex-grow flex-col gap-10 px-6 py-12">
      ...
      >
        <div class="flex flex-1 flex-col items-start gap-4">
          ...
          <RetroButton class="mt-2" @click="loginWithGitHub">
            <LogIn class="h-4 w-4" />
            Sign in with GitHub
          </RetroButton>
        </div>
